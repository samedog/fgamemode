simple gamemode daemon for FrankenpupLinux and/or Puppy Linux and now on Pop!_OS thru a series of horrible hacks :D (for Pop!_OS it requires iosched and ionice, both can be grabbed with apt)
